...
void Turtlebot3Sensor::initIR(void) 
{
  ir_pin1 = BDPIN_GPIO_16;
  ir_pin2 = BDPIN_GPIO_15;

  pinMode(ir_pin1, INPUT);
  pinMode(ir_pin2, INPUT);
}

bool Turtlebot3Sensor::getIRsensorData(void)
{
  int ir_data;
  int ir_data1 = digitalRead(ir_pin1);
  int ir_data2 = digitalRead(ir_pin2);
  if (ir_data1==0 && ir_data2 ==0)
  {
    ir_data=0;
  }
  else{
